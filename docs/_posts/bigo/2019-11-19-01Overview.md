...
This does not mean you fully base your choice of algorithm just on Big O, you should also consider the space / memory an algorithm might take since if the memory footprint of the target platform is low an algorithm which is memory efficeient might be a better choice.
